...
ContextCtl is a repo-aware prompt and rule manager. It pulls the right context for any codebase from a central store, so teams can use consistent, up-to-date prompts with any AI tool.
